...
app/client:bin/start_client.o bin/list.o bin/socket_client.o bin/log.o
	$(CC) $(CFLAGS) -o $@ $^
...
app/server:bin/start_server.o bin/handle_server_info.o bin/log.o
	$(CC) $(CFLAGS) -o $@ $^
...
bin/log.o app/client app/server
